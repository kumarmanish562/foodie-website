  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-[#0f0a0a] via-[#1a1212] to-[#2a1e1e] text-white py-10 sm:py-20 relative overflow-hidden'>
      ...
      <div className='absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none'>
        ...
        <div className='absolute bottom-1/4 right-0 w-80 h-80 bg-orange-600/15 rounded-full blur-3xl mix-blend-soft-light' />
      </div>
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative'>
        ...
        <div className='w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative group transform hover:scale-[1.0] transition-all duration-500'>
          ...
          <div className='absolute -top-6 -right-6 w-24 h-24 bg-amber-500/50 rounded-full blur-xl' />
        </div>
