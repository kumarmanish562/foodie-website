          ...
          <div className='space-y-6'>
            ...
            <form onSubmit={handleSubmit} className='relative mt-4 group'>
              ...
              <div className='relative'>
                ...
                <button
                  type='submit'
                  className='absolute right-1 top-1 bg-gradient-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition-all duration-300'
                >
...
<div className='flex justify-around md:justify-end'>
  <div className='space-y-4'>
    ...
    {/* Address Section */}
    <div className='text-sm text-amber-200 mt-4 font-lora'>
      <p className='leading-relaxed'>
        ...
        {/* Bottom Section */}
          ...
          <p className='text-amber-400 text-lg mb-2 font-playfair'>
            &copy; 2025 Foodie. All rights reserved. | Developed by <span className='text-amber-300 font-bold'>Manish Kumar</span>
          </p>
        </div>
      </div>
