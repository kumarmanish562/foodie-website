                ...
                <div className='p-6 relative z-10'>
                  ...
                  <div className='flex items-center justify-between gap-4'>
                    ...
                    {cartItem ? (
                      ...
                      //  <div   className='absolute inset-0 bg-gradient-to-r from-amber-500/20 to-transparent opacity-0 hover:opacity-100 transition-opacity duation-300'/>
                      ...
                      <button
  onClick={() =>
    addToCart({ ...item, name: item.title, price: parseFloat(item.price.replace("₹", "")) }, 1)
  }
  className="relative z-10 px-4 py-2 flex items-center gap-2 rounded-full bg-amber-500 text-black font-bold hover:bg-amber-600 transition-all duration-300 ease-in-out" 
>
  ...
  <span className="relative z-10">Add</span>
            ...
            <div className='mt-12 flex justify-center'>
              ...
              className=' flex items-center gap-3 bg-gradient-to-r from-red-700 to-amber-700 text-white px-8 py-4 rounded-2xl font-bold text-lg uppercase tracking-wider hover:gap-4 hover:scale-105 hover:shadow-amber-500/20 transition-all duraton-300 group border-2 border-amber-400/30 relative overflow-hidden'>
                <div className='absolute inste-0 bg-gradient-to-r fill-amber-500/20 via-transparent to-amber-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300'/>
