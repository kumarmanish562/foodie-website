      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8'>
          {(showAll ? initialData : initialData.slice(0, 4)).map((item, index) => {
            ...
            return (
              <div key={`${item.id}-${index}`} className="relative group bg-[#0b2012] rounded-3xl overflow-hidden shadow-2xl transform hover:-translate-y-4 transition-all duration-500 hover:shadow-green-900/40 border-2 border-transparent hover:border-green-500/20 before:absolute before:inset-0 hover:before:opacity-20">
                  ...
                  <div className='flex items-center justify-between gap-4'>
                    ...
                    {cartItem ? (
                      <div className='flex items-center gap-3'>
                        ...
                        <span className='w-8 text-center text-green-100 font-cinzel'>{quantity}</span>
                        <button
